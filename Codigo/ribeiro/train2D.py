...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        train_seq, valid_seq = ECGSequence.get_train_and_val(
            args.path_to_hdf5_train, args.path_to_hdf5_val, args.dataset_name, args.path_to_csv_train, args.path_to_csv_val, batch_size, labels = [1,2,9])
