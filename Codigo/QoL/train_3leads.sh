...
./QoL/send_telegram.sh "🚀 Iniciando entrenamiento del modelo 3 leads."
...
python "$python_script" tracings --output_file "$output_path" --path_to_hdf5_train 3lead_data/train.hdf5 --path_to_hdf5_val 3lead_data/validation.hdf5 --path_to_csv_train 3lead_data/train_db.csv --path_to_csv_val 3lead_data/validation_db.csv 2>&1 | tee "$tmp_output"
